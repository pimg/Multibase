...
class HexTest {
	...
	void testEncodeString() {
		String testStr = "Foo";
		String hexEncodedString = Multibase.HEX.getEncoder().encodeToString(testStr.getBytes(StandardCharsets.US_ASCII));
	...
	void testEncodeByteArr() {
		String testStr = "Foo";
		byte[] hexEncodedByteArr = Multibase.HEX.getEncoder().encode(testStr.getBytes(StandardCharsets.US_ASCII));
