...
class MultibaseBase64Test {
	...
	void base64EncodeTest() throws Exception {
		...
		String encodedString = Multibase.BASE64.getEncoder().encodeToString(testString.getBytes(StandardCharsets.UTF_8));
	...
	void base64EncodeToBytesTest() throws Exception {
		String testString = "this is a test string";
		byte[] encodedString = Multibase.BASE64.getEncoder().encode(testString.getBytes(StandardCharsets.UTF_8));
	...
	void base64DecodeFromBytesTest() throws Exception {
		String testString = "mdGhpcyBpcyBhIHRlc3Qgc3RyaW5n";
		byte[] decodedString = Multibase.BASE64.getDecoder().decode(testString.getBytes(StandardCharsets.UTF_8));
		assertEquals("this is a test string", new String(decodedString, StandardCharsets.UTF_8));
	}
	...
	void base64UrlEncodeTest() throws Exception {
		String testString = "this is a test string";
		String encodedString = Multibase.BASE64_URL.getEncoder().encodeToString(testString.getBytes(StandardCharsets.UTF_8));
	...
	void base64UrlEncodeToBytesTest() throws Exception {
		String testString = "this is a test string";
		byte[] encodedString = Multibase.BASE64_URL.getEncoder().encode(testString.getBytes(StandardCharsets.UTF_8));
	...
	void base64UrlDecodeFromBytesTest() throws Exception {
		String testString = "mdGhpcyBpcyBhIHRlc3Qgc3RyaW5n";
		byte[] decodedString = Multibase.BASE64_URL.getDecoder().decode(testString.getBytes(StandardCharsets.UTF_8));
		assertEquals("this is a test string", new String(decodedString, StandardCharsets.UTF_8));
	}
}
